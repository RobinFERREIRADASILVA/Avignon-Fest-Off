...
const Contact = ({ object, content, changeField, sendMessage, contactMessage, isLogged }) => {
        ...
        {contactMessage !== '' && (
          <>
            ...
            <div className="contact-message">
              <p className="contact-ok">Votre message a bien été transmit ! Vous aurez un retour dans les prochains jours.</p>
            </div>
          </>
        )}
